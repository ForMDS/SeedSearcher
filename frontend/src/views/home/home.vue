  ...
  <el-container>
    <el-aside width="600px">
      <el-form :model="{ seed_start, seed_range }" :rules="rules" ref="seedForm">
        ...
        <!-- 天气筛选组件 -->
        <WeatherFilter 
          v-model:enable_weather="weatherFilter.enable_weather.value"
          v-model:weather_clauses="weatherFilter.weather_clauses.value"
          v-model:weather_targets="weatherFilter.weather_targets.value"
          :addWeatherClause="weatherFilter.addWeatherClause"
          :removeWeatherClause="weatherFilter.removeWeatherClause"
        />

        <!-- 矿井筛选组件 -->
        <MinesFilter 
          v-model:enable_mines="minesFilter.enable_mines.value"
          v-model:mines_start_day="minesFilter.mines_start_day.value"
          v-model:mines_end_day="minesFilter.mines_end_day.value"
          v-model:floor_start="minesFilter.floor_start.value"
        ...
        <!-- 宝箱筛选组件 -->
        <ChestFilter 
          v-model:enable_chests="chestFilter.enable_chests.value"
          v-model:chest_rules_mode="chestFilter.chest_rules_mode.value"
          v-model:chest_rules="chestFilter.chest_rules.value"
          :addSimpleChestRule="chestFilter.addSimpleChestRule"
          :addOrGroupChestRule="chestFilter.addOrGroupChestRule"
          :removeChestRule="chestFilter.removeChestRule"
          :addAndSubGroup="chestFilter.addAndSubGroup"
          :removeAndSubGroup="chestFilter.removeAndSubGroup"
          :addAtomToSubGroup="chestFilter.addAtomToSubGroup"
          :removeAtomFromSubGroup="chestFilter.removeAtomFromSubGroup"
          :applyChestPreset="chestFilter.applyChestPreset"
          :getItemsByLevel="chestFilter.getItemsByLevel"
          :handleLevelChange="chestFilter.handleLevelChange"
          :handleAtomLevelChange="chestFilter.handleAtomLevelChange"
        />

        <!-- 沙漠节筛选组件 -->
        <DesertFilter 
          v-model:enable_desert="desertFilter.enable_desert.value"
          v-model:require_leah="desertFilter.require_leah.value"
          v-model:require_jas="desertFilter.require_jas.value"
        />

        <!-- 酒吧筛选组件 -->
        <SaloonFilter 
          v-model:enable_saloon="saloonFilter.enable_saloon.value"
        ...
        <!-- 夜间事件筛选组件 -->
        <NightEventFilter 
          v-model:enable_night_event="nightEventFilter.enable_night_event.value"
